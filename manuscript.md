...
- Objectives of this paper 
    ...
    - Compare MaxEnt networks with a neutral model
...
- Finding the maximum entropy distribution 
    ...
    - Example of MaxEnt distribution

# Methods

- Maximum entropy models of network structure that will be derived
