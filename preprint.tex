...
to predict \(L\) from \(S\) (Box 2), thus allowing the prediction of the
...
we standardized this measure with the rank \(R\) of the matrix
(i.e.~\(J / \ln(R)\)) to account for the difference in dimensions
between networks (\emph{sensu} Pielou's evenness; Pielou 1975). In a
following section, we will show how SVD entropy can be used to predict a
network of maximum entropy (i.e.~of maximum complexity) heuristically.
...
by orders of magnitude with increasing numbers of species and
interactions.
...
\hypertarget{box-2---working-with-predicted-numbers-of-interactions}{%
\section{Box 2 - Working with predicted numbers of
interactions}\label{box-2---working-with-predicted-numbers-of-interactions}}
